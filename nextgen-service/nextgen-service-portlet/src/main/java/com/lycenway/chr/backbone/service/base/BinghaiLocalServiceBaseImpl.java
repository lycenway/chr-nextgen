...
import com.lycenway.chr.backbone.service.BinghaiLocalService;
...
/**
 * Provides the base implementation for the Binghai Case Weixiu Wenti local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.lycenway.chr.backbone.service.impl.BinghaiLocalServiceImpl}.
 * </p>
 *
 * @author lycenway
 * @see com.lycenway.chr.backbone.service.impl.BinghaiLocalServiceImpl
 * @see com.lycenway.chr.backbone.service.BinghaiLocalServiceUtil
 * @generated
 */
public abstract class BinghaiLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements BinghaiLocalService, IdentifiableBean {
    ...
    private BinghaiLocalServiceClpInvoker _clpInvoker = new BinghaiLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.lycenway.chr.backbone.service.BinghaiLocalServiceUtil} to access the Binghai Case Weixiu Wenti local service.
     */
    ...
    @Override
    public Binghai addBinghai(Binghai binghai) throws SystemException {
        binghai.setNew(true);

        return binghaiPersistence.update(binghai);
    }
     ...
     */
    @Override
    public Binghai createBinghai(long binghaiId) {
        return binghaiPersistence.create(binghaiId);
    }
    ...
    @Override
    public Binghai deleteBinghai(long binghaiId)
        throws PortalException, SystemException {
        return binghaiPersistence.remove(binghaiId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Binghai deleteBinghai(Binghai binghai) throws SystemException {
        return binghaiPersistence.remove(binghai);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Binghai.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return binghaiPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return binghaiPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return binghaiPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return binghaiPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return binghaiPersistence.countWithDynamicQuery(dynamicQuery, projection);
    }

    @Override
    public Binghai fetchBinghai(long binghaiId) throws SystemException {
        return binghaiPersistence.fetchByPrimaryKey(binghaiId);
    }
     ...
     */
    @Override
    public Binghai getBinghai(long binghaiId)
        throws PortalException, SystemException {
        return binghaiPersistence.findByPrimaryKey(binghaiId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return binghaiPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<Binghai> getBinghais(int start, int end)
        throws SystemException {
        return binghaiPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getBinghaisCount() throws SystemException {
        return binghaiPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Binghai updateBinghai(Binghai binghai) throws SystemException {
        return binghaiPersistence.update(binghai);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.lycenway.chr.backbone.model.Binghai",
            binghaiLocalService);
    }
