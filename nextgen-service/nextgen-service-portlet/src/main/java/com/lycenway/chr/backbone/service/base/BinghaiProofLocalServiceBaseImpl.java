...
import com.lycenway.chr.backbone.service.BinghaiProofLocalService;
...
/**
 * Provides the base implementation for the Binghai Attachments Pictures local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.lycenway.chr.backbone.service.impl.BinghaiProofLocalServiceImpl}.
 * </p>
 *
 * @author lycenway
 ...
 * @generated
 */
public abstract class BinghaiProofLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements BinghaiProofLocalService,
        IdentifiableBean {
    ...
    private BinghaiProofLocalServiceClpInvoker _clpInvoker = new BinghaiProofLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.lycenway.chr.backbone.service.BinghaiProofLocalServiceUtil} to access the Binghai Attachments Pictures local service.
     */
    ...
    @Override
    public BinghaiProof addBinghaiProof(BinghaiProof binghaiProof)
        throws SystemException {
        binghaiProof.setNew(true);

        return binghaiProofPersistence.update(binghaiProof);
    }
     ...
     */
    @Override
    public BinghaiProof createBinghaiProof(long binghaiProofId) {
        return binghaiProofPersistence.create(binghaiProofId);
    }
    ...
    @Override
    public BinghaiProof deleteBinghaiProof(long binghaiProofId)
        throws PortalException, SystemException {
        return binghaiProofPersistence.remove(binghaiProofId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public BinghaiProof deleteBinghaiProof(BinghaiProof binghaiProof)
        throws SystemException {
        return binghaiProofPersistence.remove(binghaiProof);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(BinghaiProof.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return binghaiProofPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return binghaiProofPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public BinghaiProof fetchBinghaiProof(long binghaiProofId)
        throws SystemException {
        return binghaiProofPersistence.fetchByPrimaryKey(binghaiProofId);
    }
     ...
     */
    @Override
    public BinghaiProof getBinghaiProof(long binghaiProofId)
        throws PortalException, SystemException {
        return binghaiProofPersistence.findByPrimaryKey(binghaiProofId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return binghaiProofPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<BinghaiProof> getBinghaiProofs(int start, int end)
        throws SystemException {
        return binghaiProofPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getBinghaiProofsCount() throws SystemException {
        return binghaiProofPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public BinghaiProof updateBinghaiProof(BinghaiProof binghaiProof)
        throws SystemException {
        return binghaiProofPersistence.update(binghaiProof);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.lycenway.chr.backbone.model.BinghaiProof",
            binghaiProofLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = binghaiProofPersistence.getDataSource();
