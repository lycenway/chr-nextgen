...
/**
 * Provides the local service utility for MuInterrel. This utility wraps
 * {@link com.lycenway.chr.backbone.service.impl.MuInterrelLocalServiceImpl} and is the
 ...
 * @generated
 */
public class MuInterrelLocalServiceUtil {
    private static MuInterrelLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.lycenway.chr.backbone.service.impl.MuInterrelLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.lycenway.chr.backbone.model.MuInterrel addMuInterrel(
        com.lycenway.chr.backbone.model.MuInterrel muInterrel)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().addMuInterrel(muInterrel);
    }
    ...
    */
    public static com.lycenway.chr.backbone.model.MuInterrel createMuInterrel(
        long muInterrelId) {
        return getService().createMuInterrel(muInterrelId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.lycenway.chr.backbone.model.MuInterrel deleteMuInterrel(
        long muInterrelId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteMuInterrel(muInterrelId);
    }
    ...
    */
    public static com.lycenway.chr.backbone.model.MuInterrel deleteMuInterrel(
        com.lycenway.chr.backbone.model.MuInterrel muInterrel)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteMuInterrel(muInterrel);
    }
    ...
    */
    ...
    public static com.lycenway.chr.backbone.model.MuInterrel fetchMuInterrel(
        long muInterrelId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchMuInterrel(muInterrelId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.lycenway.chr.backbone.model.MuInterrel getMuInterrel(
        long muInterrelId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getMuInterrel(muInterrelId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.lycenway.chr.backbone.model.MuInterrel> getMuInterrels(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getMuInterrels(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getMuInterrelsCount()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getMuInterrelsCount();
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.lycenway.chr.backbone.model.MuInterrel updateMuInterrel(
        com.lycenway.chr.backbone.model.MuInterrel muInterrel)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateMuInterrel(muInterrel);
    }
    ...
    */
    ...
    public static MuInterrelLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    MuInterrelLocalService.class.getName());

            if (invokableLocalService instanceof MuInterrelLocalService) {
                _service = (MuInterrelLocalService) invokableLocalService;
            } else {
                _service = new MuInterrelLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(MuInterrelLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(MuInterrelLocalService service) {
    }
}
