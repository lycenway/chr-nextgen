...
/**
 * Provides the local service utility for MuExt. This utility wraps
 * {@link com.lycenway.chr.backbone.service.impl.MuExtLocalServiceImpl} and is the
 ...
 * @see com.lycenway.chr.backbone.service.base.MuExtLocalServiceBaseImpl
 * @see com.lycenway.chr.backbone.service.impl.MuExtLocalServiceImpl
 * @generated
 */
public class MuExtLocalServiceUtil {
    private static MuExtLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.lycenway.chr.backbone.service.impl.MuExtLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.lycenway.chr.backbone.model.MuExt addMuExt(
        com.lycenway.chr.backbone.model.MuExt muExt)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().addMuExt(muExt);
    }
    ...
    */
    public static com.lycenway.chr.backbone.model.MuExt createMuExt(
        long muExtId) {
        return getService().createMuExt(muExtId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.lycenway.chr.backbone.model.MuExt deleteMuExt(
        long muExtId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteMuExt(muExtId);
    }
    ...
    */
    public static com.lycenway.chr.backbone.model.MuExt deleteMuExt(
        com.lycenway.chr.backbone.model.MuExt muExt)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteMuExt(muExt);
    }
    ...
    */
    ...
    public static com.lycenway.chr.backbone.model.MuExt fetchMuExt(long muExtId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchMuExt(muExtId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.lycenway.chr.backbone.model.MuExt getMuExt(long muExtId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getMuExt(muExtId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.lycenway.chr.backbone.model.MuExt> getMuExts(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getMuExts(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getMuExtsCount()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getMuExtsCount();
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.lycenway.chr.backbone.model.MuExt updateMuExt(
        com.lycenway.chr.backbone.model.MuExt muExt)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateMuExt(muExt);
    }
    ...
    */
    ...
    public static MuExtLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    MuExtLocalService.class.getName());

            if (invokableLocalService instanceof MuExtLocalService) {
                _service = (MuExtLocalService) invokableLocalService;
            } else {
                _service = new MuExtLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(MuExtLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(MuExtLocalService service) {
    }
}
