...
/**
 * Provides the local service interface for MuZhengxianPodao. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author lycenway
 * @see MuZhengxianPodaoLocalServiceUtil
...
public interface MuZhengxianPodaoLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link MuZhengxianPodaoLocalServiceUtil} to access the Mgmt Unit of Zhengxian Podao local service. Add custom service methods to {@link com.lycenway.chr.backbone.service.impl.MuZhengxianPodaoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
