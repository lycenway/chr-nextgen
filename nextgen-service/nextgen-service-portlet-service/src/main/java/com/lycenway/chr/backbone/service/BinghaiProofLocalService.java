...
/**
 * Provides the local service interface for BinghaiProof. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author lycenway
 * @see BinghaiProofLocalServiceUtil
...
public interface BinghaiProofLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link BinghaiProofLocalServiceUtil} to access the Binghai Attachments Pictures local service. Add custom service methods to {@link com.lycenway.chr.backbone.service.impl.BinghaiProofLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
