...
/**
 * Provides the local service interface for BinghaiPingfen. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author lycenway
 * @see BinghaiPingfenLocalServiceUtil
...
public interface BinghaiPingfenLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link BinghaiPingfenLocalServiceUtil} to access the binghai pingfen local service. Add custom service methods to {@link com.lycenway.chr.backbone.service.impl.BinghaiPingfenLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
